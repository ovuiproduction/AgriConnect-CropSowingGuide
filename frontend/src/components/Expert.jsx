...
export default function Expert() {
  ...
  return (
    <>
      ...
      <div className="alerts">{status == "ok" && <AlertSuccess />}</div>
      ...
      <form className="addPesticideForm">
        ...
        <div className="mb-3">
          <label htmlFor="pesticidename" className="form-label">
            Pesticide Name
          </label>
          <input
            value={pesticidename}
        ...
        <div className="mb-3">
          <label htmlFor="pesticidetype" className="form-label">
            Type of Pesticide
          </label>
          <select
            value={usedfor}
        ...
        <div className="mb-3">
          <label htmlFor="methodtouse" className="form-label">
            Manual
          </label>
          <textarea
            value={manual}
            ...
            id="methodtouse"
            rows="3"
            placeholder="Enter method to use"
          ></textarea>
        </div>
        <div className="mb-3">
          <label htmlFor="pesticidetype" className="form-label">
        ...
        <button onClick={onHandleSubmit} className="btn btn-primary">
          Submit
        </button>
      </form>
      <script
